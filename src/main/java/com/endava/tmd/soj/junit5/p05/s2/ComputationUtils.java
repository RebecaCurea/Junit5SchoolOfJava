...
public class ComputationUtils {
  ...
  public  static int orderedNumbersSum(int x, int y) {
        if (x > 0) {
   ...
   public static int orderedPositiveNumbersSum(int x, int y) {
    ...
    static int orderedNegativeNumbersSum(int x, int y) {
